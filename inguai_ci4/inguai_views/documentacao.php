			...
			<div class="container-fluid container-fluid-mr" style="position: relative; padding-top:15px;">
				<div class="row justify-content-start align-items-start">
					<div class="col-3" style="position: relative;">
						<div class="card card_docs_list">
						<ul>
							<li><a href="#INICIO" data-target="#INICIO" class="link-ancora">Sobre o Projeto</a></li>
							<li><a href="#INFO-BASICAS" data-target="#INFO-BASICAS" class="link-ancora">Informações Básicas</a></li>
							<li><a href="#DESIGN-PATTERN" data-target="#DESIGN-PATTERN" class="link-ancora">Design Patterns</a></li>
							<li><a href="#BANCO-DE-DADOS" data-target="#BANCO-DE-DADOS" class="link-ancora">Banco de Dados</a></li>
							<li><a href="#ASSETS" data-target="#ASSETS" class="link-ancora">Assets</a></li>
							<li><a href="#ESTRUTURA" data-target="#ESTRUTURA" class="link-ancora">Estrutura do FrameWork</a></li>
						</ul>
						</div>
					</div>
					<div class="col-8">
