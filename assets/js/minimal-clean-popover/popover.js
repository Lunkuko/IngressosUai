...
(function ($) {
    ...
    var defaults = {
        ...
        autoPlace : true,//
        delay : 10, 
        placement : 'right',		//'top', 'topLeft',    'topRight',
    ...
    Popover.prototype.render = function(){
        ...
        _this.product = $('#'+_pid);
        _this.wrapper = _this.product.parent('div');
        this.place();
    };
    Popover.prototype.place = function(){
		...
		//_product.addClass('active-'+_this.opts.itemID);
		_product.addClass('activeitem');
		_product.addClass(_this.opts.csspop); 
    ...
    $.fn.popovermin = function(options) {
        var _this = this;
